...
class reooModelunitdetails extends JModelLegacy
{
 ...
 function getDown()
    {
	    $q = 'select Image from #__sspimages where ID =1000000023 ' ;
	    $this->_db->setQuery($q);
     	//$data = $this->_db->loadResultArray(); Deprecated 
     	$data = $this->_db->loadColumn();
	    return $data;
	 ...
	 function getGate()
    {
	    $q = 'select Image from #__sspimages where ID =1000000024 ' ;
	    $this->_db->setQuery($q);
     	//$data = $this->_db->loadResultArray(); Deprecated 
     	$data = $this->_db->loadColumn();
	    return $data;
    ...
    {
	    $q = 'select Image from #__sspimages where ID =1000000026 ' ;
	    $this->_db->setQuery($q);
     	//$data = $this->_db->loadResultArray(); Deprecated 
     	$data = $this->_db->loadColumn();
	    return $data;
