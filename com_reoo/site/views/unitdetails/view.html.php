...
class reooViewunitdetails extends JViewLegacy
{
    ...
    function display($tpl = null)
    {
        ...
        if($user->id)
        {
			...
			$imagesDown = $model->getDown();
            $this->assignRef('Down', $imagesDown);
			$imagesGate = $model->getGate();
            $this->assignRef('Gate', $imagesGate);
			$imagesPanorama = $model->getPanorama();
            $this->assignRef('Panorama', $imagesPanorama);
        }
