 ...
 * @subpackage Models
 */
class customersModelcustomerunits extends JModelLegacy
{
	/**
	 * Gets the greetings
	...
	function getCustomersUnits()
	{
		...
		$query = 'SELECT #__sscontracts.ID as CID,#__sscontracts.UnitID as ID,#__sscontracts.TotalValue, if(#__ssconstructionphases.Name'.$ext.'<>"",#__ssconstructionphases.Name'.$ext.',#__ssconstructionphases.Name) as ConstructionPhase,#__ssunits.PlotNumber,
                    ...
                    inner join #__ssunits on #__ssunits.ID = #__sscontracts.UnitID
                    inner join #__ssprojects on #__ssprojects.ID = #__ssunits.ProjectID
                    inner join #__ssconstructionphases on #__ssconstructionphases.ID = #__ssunits.ConstructionPhaseID
